#ifndef FUNCIONMATRI_C_INCLUDED
#define FUNCIONMATRI_C_INCLUDED
...
int SuperiorDiagPri(int mat[][COL],int fil,int col)
{
    ...
    for(i=0;i<fil-1;i++)
    {
       printf("%*s",2*i,"");            ///* indica que la cantidad que ocupa se lo indico como un parametro mas
     for(j=1;j<col;j++)
     {
